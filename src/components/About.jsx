              ...
              <div className="mobile-reviews-section">
                <div className="mobile-review-card">
                  ...
                  <p className="mobile-review-body">
                    Нужно было срочно сделать приглашение на мой день рождения, ребята справились быстро! Спасибо за оперативную и качественную работу. Сайт удобный, всё понятно, а результат превзошёл ожидания. Рекомендую!
                  </p>
                ...
                <div className="mobile-review-card">
                  ...
                  <p className="mobile-review-body">
                    Заказали сайт для цветочного магазина. Сделали быстро и качественно. Отдельно хочу отметить удобный конструктор букетов, где клиенты могут самостоятельно собирать композиции, и продуманную админ панель для управления сайтом.
                  </p>
